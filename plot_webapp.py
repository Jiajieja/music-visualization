...
app.init(
    ...
    audio_file="/Users/xiaojie/Downloads/Color_Out_-_Host.mp3",  # audio file to load at start up
)

# Run the app in debug mode and specify the port for localhost access
app.run(debug=True, port=8050)  # you can specify any available port here
